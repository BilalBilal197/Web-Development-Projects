...
class Home extends Component{
  ...
  async componentDidMount(){
    ...
    Promise.all(citiesPromises).then((data)=>{
      ...
      const europeCities = data[0].data;
      const asiaCities = data[0].data;
      const exoticCities = data[0].data;
      this.setState({
        ...
        <div className="container-fluid lower-fold">
          <div className="row">
            ...
            <div className="col s12">
              <Cities cities={this.state.cities} header={this.state.cities.header}/>
            </div>
            <div className="col s12">
